...
const NavLink = ({ text, href, FlyoutContent, flyoutWidth = 800 }) => {
  ...
  // Centre the panel on the viewport without any CSS transform.
  // left = 50vw − half the menu width, clamped to 16 px so it never bleeds off screen.
  const flyoutStyle = {
    position: "fixed",
    top: "106px",
