import {
  ...
  const MagnetButtonExample = () => {
    return (
      <div className="grid min-h-[400px] place-content-center p-4">
        <MagnetButton />
      </div>
    );
  };
  ...
  const MagnetButton = () => {
    ...
    return (
      ...
      >
        <MdOutlineArrowUpward className="pointer-events-none relative z-10 rotate-45 text-7xl text-white transition-all duration-700 ease-out group-hover:rotate-90" />
        ...
        >
          ...
          <text>
            ...
            >
              Explore the stunning results of our creative work today
            </textPath>
          </text>
        </motion.svg>
      </motion.button>
