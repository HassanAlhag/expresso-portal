...
const FALLBACK_SLIDES = [
  ...
  },
  {
    ...
    eyebrowLeft: "EXPRESSO DIGITAL",
    eyebrowRight: "GROWTH SYSTEMS",
    heading: "Grow Your Brand Online",
    description:
      "From social media management to content creation and community engagement — we put your brand in front of the right audience.",
    mainBg: "/home3.jpg",
    thumbImage: "/creative.jpg",
    ctaLabel: "Explore Services",
    ctaUrl: "/services",
    secondaryCtaLabel: "Talk to Us",
    secondaryCtaUrl: "/contact-us",
  },
  {
    ...
    eyebrowLeft: "EXPRESSO DIGITAL",
    eyebrowRight: "GROWTH SYSTEMS",
    heading: "Drive Results with Smart Ads",
    description:
      "High-intent Google Ads and performance marketing campaigns engineered for maximum ROI and measurable business outcomes.",
    mainBg: "/home4.jpg",
    thumbImage: "/business.webp",
    ctaLabel: "Explore Services",
    ctaUrl: "/services",
    secondaryCtaLabel: "Talk to Us",
    secondaryCtaUrl: "/contact-us",
  },
  {
    ...
    eyebrowLeft: "EXPRESSO DIGITAL",
    eyebrowRight: "GROWTH SYSTEMS",
    heading: "Scale with Technology",
    description:
      "Custom web applications, ERP solutions, CRM systems, and enterprise software built to streamline and accelerate your operations.",
    mainBg: "/developing.webp",
    thumbImage: "/responsive.jpg",
    ctaLabel: "Explore Services",
    ctaUrl: "/services",
    secondaryCtaLabel: "Talk to Us",
    secondaryCtaUrl: "/contact-us",
...
function normalizeSlides(items) {
  ...
  return rows
    ...
    .map((item, index) => ({
      ...
      mainBg: item.imageUrl || item.mainBg || "/home2.jpg",
